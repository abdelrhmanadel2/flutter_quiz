...
import 'package:flutter_quiz/views/welcomePage/trainque2.dart';
...
class _hjState extends State<hj> {
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              Text('تراجع', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500))
            ],
          ),
        ),
      ),
    ...
    return Column(children: [
      Container(
        ...
        Directionality(
          ...
          child: Text('اذا كان لديك 7 اقلام وقمت ببيع 3 كم تبقى قلم لديك؟',
              style: GoogleFonts.almarai(
                textStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 30, color: Colors.brown),
              )),
        ),
        Divider(
          color: Colors.transparent,
        ...
        Directionality(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(border: Border.all(color: Colors.orange, width: 5), borderRadius: BorderRadius.all(Radius.circular(30.0))),
            child: RadioListTile(
              title: Text("7",
                  style: GoogleFonts.almarai(
                    textStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.orange),
                  )),
              value: "احمر",
              groupValue: gender,
              onChanged: (value) {
        ...
        Directionality(
          ...
          child: Container(
            margin: const EdgeInsets.all(15.0),
            padding: const EdgeInsets.all(3.0),
            decoration: BoxDecoration(border: Border.all(color: Colors.green, width: 5), borderRadius: BorderRadius.all(Radius.circular(30.0))),
            child: RadioListTile(
              title: Text("4",
                  style: GoogleFonts.almarai(
                    textStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.orange),
  ...
  Widget move() {
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => trainn()));
      },
      child: Positioned(
        top: 0,
        left: 100,
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              Text('انتقال', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500))
            ],
          ),
        ),
      ),
